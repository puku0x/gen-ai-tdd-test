...
- **Fake it till you make it** - Start with hard-coded returns based on issue examples, then generalize
...
- **Use basic collections** - Simple `Array` or `Object` over complex data structures
